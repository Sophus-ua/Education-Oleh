...
select e.FName as Emp_FName, e.LName as Emp_LName, c.FName as Cust_FName, c.LName as Cust_LName, sum(od.TotalPrice) as TotalPrice 
from employees as e
inner join orders as o on e.EmployeeID = o.employeeID
inner join customers as c on c.CustomerNO = o.CustomerNO
inner join orderdetails as od on o.OrderID = od.OrderID
group by e.EmployeeID, c.CustomerNO
