...
select E.First_Name, E.Last_Name, E.Phone, EP.Address from Employees as E
join Employees_private_information as EP
on E.Private_info_ID = EP.ID;


select E.First_Name, E.Last_Name, Ep.Date_of_birth, E.Phone from Employees as E
join Employees_private_information as EP
on E.Private_info_ID = EP.ID
where EP.Marital_status like 'Single';
